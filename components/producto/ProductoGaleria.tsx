...
/**
 * Galería de producto: foto principal 4:3 + cinco miniaturas.
 * Las fotos salen de PRODUCTO_GALERIA, así que se reemplazan editando esa
 * lista sin tocar este componente.
 *
...
export default function ProductoGaleria() {
  ...
  return (
    <div>
      <div className="relative aspect-[4/3] w-full overflow-hidden rounded-image bg-superficie-clara">
        <Image
          src={foto.src}
          alt={foto.alt}
          fill
